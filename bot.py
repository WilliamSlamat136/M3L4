...
# Fungsi ini akan berjalan ketika bot dijalankan
@bot.event
async def on_ready():
    print(f'Bot is ready. Logged in as {bot.user}')

# Fungsi command ketika bot mulai dijalankan
...
# Fungsi info perintah-perintah yang dapat dijalankan
...
# Fungsi untuk menambahkan skills kedalam proyek
...
# Memperbarui nama dan link Proyek
